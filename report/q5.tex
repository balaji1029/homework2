...
\subsubsection{Part 6}
    ...
    \end{align*}
    For a proof that the expectation of a product of independent random variables is equal to the product of their expectations, look at \ref{ref:10}.\\
    ...
    \end{equation}
    This is just the Moment generating function of a Gaussian random variable, Hence Y is a Gaussian random variable. Since Z is a special case of a linear combination of independent Gaussian variables, Z is also a Gaussian random variable.
\subsection{Task D}
